...
If that sounds like a lot of work, that’s because it _is_. Each lesson takes a lot of effort, so a course amounts to the effort for all the lessons you need to create, and then a little more.
