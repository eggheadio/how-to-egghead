...
published: true
shareImage: 'https://res.cloudinary.com/dg3gyk0gu/image/upload/v1589276052/og-image-assets/case-study-joe-previte.png'
---
...
![A snippet from Joe's Medium in August 2018 talking about starting screencasting](./images/joe-jfdi.png)
...
![Joe's YouTube video on how to automate your Chrome Extension Deployment with Travis CI](./images/first-screencast.png)
...
![Scott Spence gives Joe's course a 5 star review](./images/Scott-spence-review.png)

![Idan gives Joe's course a 5 star review](./images/Idan-review.png)

![Andres Rodriguez gives Joe's course a 5 star review](./images/andres-reodriguez-review.png)
