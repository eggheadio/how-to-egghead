...
![web browser displaying egghead collection page which includes a title, a description, and a list of videos](./images/collections-screenshot.png)

Collections belong to you, the instructor, and don't require the same rigor and planning that [creating a full blown egghead Course](/instructor/workshops) requires. You don't need to ask permission or go through a lot of planning steps to create a collection.
...
1. Is this [useful for web developers](/instructor/style-guide/what-to-teach)?
2. Does it fit within the boundaries of [the egghead Community Code of Conduct](/code-of-conduct)?
...
If you visit your instructor page you will see a button labeled "create new collection". Clicking that will navigate you to the ["new playlist" page](https://egghead.io/playlists/new) where you can give the collection a title, solid description, and start adding lessons to it.
