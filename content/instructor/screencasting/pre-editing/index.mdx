...
description: "Whether it's you or somebody else, a video editor create the final versions of your course. These are some techniques to follow when recording."
categories: ['instructor']
guide: 'instructor'
published: true
---

Whether it's you or somebody else, a video editor create the final versions of your course. These are some techniques to follow when recording.
