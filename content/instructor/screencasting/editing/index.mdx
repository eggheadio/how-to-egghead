...
description: 'Creating concise badass screnncast lessons requires a little post processing.'
...
Editing is also a skill. It can be tediouis, particularly if you are just learning how to do it. 
