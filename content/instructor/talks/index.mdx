...
<Flex sx={{mx: [-3, -5], flexDirection: 'row', justifyContent: 'center', alignItems: 'center', px: [2, 5], py:4, backgroundColor: 'background', fontFamily: 'heading', fontSize: 3, fontWeight: 600}}>
<Flex sx={{flexDirection: 'column', alignItems: 'center',}}>
<Text sx={{mb: 3, fontSize: 4}}>Ready to submit?</Text>
<StyledLink sx={{bg: 'primary', cursor: 'pointer', p: 3, borderRadius: 5}} href="https://eggheadio.typeform.com/to/HLrOT0">
<span style={{color: 'white'}}>Click here to submit your proposal</span>
</StyledLink>
</Flex>
</Flex>
