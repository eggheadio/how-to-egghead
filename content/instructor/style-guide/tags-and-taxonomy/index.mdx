...
- Courcollectionsses should be tagged with the same technology and skill taxonomies as individual resources. These shouldn’t automatically be inherited up: if a collection includes a single React lesson, the collection shouldn’t be tagged with React. But if the collection as a whole is a bunch of resources about integrating React into your workflow, it should be tagged with React.
