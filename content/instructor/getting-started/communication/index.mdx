...
If your an egghead instructor, we've likely communicated via email already. We use and enjoy email as a primary form of asynchronous conversation. For the most part it has an adequate response time, thankfully "egghead emergencies" are not a thing.
