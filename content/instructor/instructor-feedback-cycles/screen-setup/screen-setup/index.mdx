...
This lesson became [“Build a GraphQL Query using Gatsby’s GraphiQL Explorer”](https://egghead.io/lessons/gatsby-build-a-graphql-query-using-gatsby-s-graphiql-explorer) by [Emma Bostian](https://egghead.io/instructors/emma-bostian).
